...
draw = mediapipe.solutions.drawing_utils  # Object to draw the connections between each finger and their indicies
...
def handLandmarks(colorImg): #Takes each frame of webcam, converts from vgr to rgb, and then feeds it to the method
...
def fingers(landmarks):
    ...
    #Since thumb has 1 less joint, we have to check if the thumb is lower than the first joint. If it is, return 0.
